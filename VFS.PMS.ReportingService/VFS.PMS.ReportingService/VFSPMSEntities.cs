...
namespace VFS.PMS.ReportingService
{
	...
	public partial class VFSPMSEntitiesDataContext : Microsoft.SharePoint.Linq.DataContext {
		...
		public Microsoft.SharePoint.Linq.EntityList<AppraisalCompetenciesDraftItem> AppraisalCompetenciesDraft {
			get {
				return this.GetList<AppraisalCompetenciesDraftItem>("Appraisal Competencies Draft");
			}
		}
		...
		public Microsoft.SharePoint.Linq.EntityList<AppraisalDevelopmentMeasuresDraftItem> AppraisalDevelopmentMeasuresDraft {
			get {
				return this.GetList<AppraisalDevelopmentMeasuresDraftItem>("Appraisal Development Measures Draft");
			}
		}
		...
		public Microsoft.SharePoint.Linq.EntityList<AppraisalGoalsDraftItem> AppraisalGoalsDraft {
			get {
				return this.GetList<AppraisalGoalsDraftItem>("Appraisal Goals Draft");
			}
		}
		...
		public Microsoft.SharePoint.Linq.EntityList<PIPDraftItem> PIPDraft {
			get {
				return this.GetList<PIPDraftItem>("PIP Draft");
			}
		}
		...
		public Microsoft.SharePoint.Linq.EntityList<TasksTask> Tasks {
			get {
				return this.GetList<TasksTask>("Tasks");
			}
		}
		...
		[Microsoft.SharePoint.Linq.ListAttribute(Name="Test Reports")]
		public Microsoft.SharePoint.Linq.EntityList<Document> TestReports {
			get {
				return this.GetList<Document>("Test Reports");
			}
		}
		
		[Microsoft.SharePoint.Linq.ListAttribute(Name="TMT Actions")]
		public Microsoft.SharePoint.Linq.EntityList<TMTActionsItem> TMTActions {
			get {
				return this.GetList<TMTActionsItem>("TMT Actions");
			}
		}
		
		[Microsoft.SharePoint.Linq.ListAttribute(Name="VFSAppraisalTasks")]
		public Microsoft.SharePoint.Linq.EntityList<VFSAppraisalTasksTask> VFSAppraisalTasks {
			get {
				return this.GetList<VFSAppraisalTasksTask>("VFSAppraisalTasks");
			}
		}
		
		[Microsoft.SharePoint.Linq.ListAttribute(Name="V-Perform")]
		public Microsoft.SharePoint.Linq.EntityList<VPerformWikiPage> VPerform {
			get {
				return this.GetList<VPerformWikiPage>("V-Perform");
			}
		}
		
		[Microsoft.SharePoint.Linq.ListAttribute(Name="V-Perform Wiki")]
		public Microsoft.SharePoint.Linq.EntityList<VPerformWikiWikiPage> VPerformWiki {
			get {
				return this.GetList<VPerformWikiWikiPage>("V-Perform Wiki");
			}
		}
		
		[Microsoft.SharePoint.Linq.ListAttribute(Name="V-Performwiki")]
		public Microsoft.SharePoint.Linq.EntityList<VPerformwikiPicture> VPerformwiki {
			get {
				return this.GetList<VPerformwikiPicture>("V-Performwiki");
			}
		}
		...
		public Microsoft.SharePoint.Linq.EntityList<WorkflowTasksTask> WorkflowTasks {
			get {
				return this.GetList<WorkflowTasksTask>("Workflow Tasks");
			}
		}
	}
	...
	[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(PIPDraftItem))]
	...
	[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(RemindersFolder))]
	...
	[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(WebPartPageWithStatusList))]
	...
	[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(VPerformWikiPage))]
	[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(VPerformWikiWikiPage))]
	...
	[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(VPerformwikiPicture))]
	...
	public partial class AppraisalPhasesItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="IsReview", Storage="_isReview", FieldType="Choice")]
	...
	public partial class AppraisalWorkflowHistoryItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Appraisal", Storage="_appraisal", FieldType="Number")]
		public System.Nullable<double> Appraisal {
			get {
				return this._appraisal;
			}
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="From_x0020_Status", Storage="_fromStatus", FieldType="Text")]
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="To_x0020_Status", Storage="_toStatus", FieldType="Text")]
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Actor", Storage="_actor", FieldType="Number")]
	...
	public partial class AppraisalsItem : Item {
		...
		private System.Nullable<int> _vPerformWorkflow;
		
		private System.Nullable<int> _appraisalWorkflow;
		
		private System.Nullable<Deactivated> _deactivated;
		
		private System.Nullable<IsReview0> _isReview;
        ...
        //[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPerform", Storage="_vPerformWorkflow", ReadOnly=true, FieldType="WorkflowStatus")]
        //public System.Nullable<int> VPerformWorkflow {
        //    get {
        //        return this._vPerformWorkflow;
        //    }
        //    set {
        //        if ((value != this._vPerformWorkflow)) {
        //            this.OnPropertyChanging("VPerformWorkflow", this._vPerformWorkflow);
        //            this._vPerformWorkflow = value;
        //            this.OnPropertyChanged("VPerformWorkflow");
        //        }
        //    }
        //}
		
        //[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Appraisa", Storage="_appraisalWorkflow", ReadOnly=true, FieldType="WorkflowStatus")]
        //public System.Nullable<int> AppraisalWorkflow {
        //    get {
        //        return this._appraisalWorkflow;
        //    }
        //    set {
        //        if ((value != this._appraisalWorkflow)) {
        //            this.OnPropertyChanging("AppraisalWorkflow", this._appraisalWorkflow);
        //            this._appraisalWorkflow = value;
        //            this.OnPropertyChanged("AppraisalWorkflow");
        //        }
        //    }
        //}
		...
		public System.Nullable<IsReview0> IsReview {
			get {
				return this._isReview;
			}
			set {
	...
	public partial class AreasItem : Item {
		...
		/// Personnel Area Code
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="PersonnelAreaCode", Storage="_personnelAreaCode", FieldType="Text")]
		...
		/// Personnel Area Text
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="PersonnelAreaText", Storage="_personnelAreaText", FieldType="Text")]
	...
	public partial class CompaniesItem : Item {
		...
		/// Company Code
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="CompanyCode", Storage="_companyCode", FieldType="Number")]
		...
		/// Company Name
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="CompanyName", Storage="_companyName", FieldType="Text")]
	...
	public partial class CompetencyDescriptionsItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="cmptCompetency", Storage="_competency", FieldType="Text")]
		public string Competency {
			get {
				return this._competency;
			}
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="cmptDescription", Storage="_description", FieldType="Note")]
		public string Description {
			get {
				return this._description;
			}
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="cmptEmpSubGroup", Storage="_employeeSubGroup", FieldType="Text")]
	...
	public partial class CompetencyRatingsItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Rating", Storage="_rating", FieldType="Text")]
		public string Rating {
			get {
				return this._rating;
			}
	...
	public partial class ContentAndStructureReportsItem : Item {
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="_x0024_Resources_x003a_cmscore_x2", Storage="_cAMLQuery", FieldType="Text")]
	...
	public partial class EmployeeGroupsItem : Item {
		...
		/// Employee Group Code
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="EmployeeGroupCode", Storage="_employeeGroupCode", FieldType="Text")]
		...
		/// Employee Group Text
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="EmployeeGroupText", Storage="_employeeGroupText", FieldType="Text")]
	...
	public partial class EmployeeSubGroupsItem : Item {
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="EmployeeSubGroupCode", Storage="_employeeSubGroupCode", FieldType="Text")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="EmployeeSubGroupText", Storage="_employeeSubGroupText", FieldType="Text")]
	...
	public partial class EmployeesMasterItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="WindowsLogin", Storage="_windowsLogin", FieldType="Text")]
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="EmployeeCode", Storage="_employeeCode", FieldType="Number")]
		...
		/// Organization Unit
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="OrganizationUnit", Storage="_organizationUnit", FieldType="Text")]
		...
		/// Position Text
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Position", Storage="_position", FieldType="Text")]
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="HireDate", Storage="_hireDate", FieldType="DateTime")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="ReportingManagerEmployeeCode", Storage="_reportingManagerEmployeeCode", FieldType="Number")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="ReportingManagerName", Storage="_reportingManagerName", FieldType="Text")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="HRBusinessPartnerEmployeeCode", Storage="_hRBusinessPartnerEmployeeCode", FieldType="Number")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="HRBusinessPartnerName", Storage="_hRBusinessPartnerName", FieldType="Text")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="DepartmentHeadEmployeeCode", Storage="_departmentHeadEmployeeCode", FieldType="Number")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="DepartmentHeadName", Storage="_departmentHeadName", FieldType="Text")]
	...
	public partial class OrganizationUnitsItem : Item {
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="OrganizationUnitCode", Storage="_organizationUnitCode", FieldType="Number")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="OrganizationUnitShortText", Storage="_organizationUnitShortText", FieldType="Text")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="OrganizationUnitLongText", Storage="_organizationUnitLongText", FieldType="Text")]
	...
	public partial class PerformanceCycleActivityItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="PerformanceCycle", Storage="_performanceCycle", FieldType="Number")]
		public System.Nullable<double> PerformanceCycle {
			get {
				return this._performanceCycle;
			}
	...
	public partial class PerformanceCyclesItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Performance_x0020_Cycle", Storage="_performanceCycle", FieldType="Number")]
		public System.Nullable<double> PerformanceCycle {
			get {
				return this._performanceCycle;
			}
	...
	public partial class PhasesItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Phase", Storage="_phase", FieldType="Text")]
		public string Phase {
			get {
				return this._phase;
			}
	...
	/// Create a new list item.
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Item", Id="0x01", List="PIP Draft")]
	public partial class PIPDraftItem : Item {
	...
	public partial class PMSDataFileLocationsItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="FileLocation", Storage="_fileLocation", FieldType="Text")]
	...
	public partial class PositionsItem : Item {
		...
		/// Position Code
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="PositionCode", Storage="_positionCode", FieldType="Number")]
		...
		/// Position Short Text
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="PositionShortText", Storage="_positionShortText", FieldType="Text")]
		...
		/// Position Long Text
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="PositionLongText", Storage="_positionLongText", FieldType="Text")]
	...
	public partial class RegionsItem : Item {
		...
		/// Region Name
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="RegionName", Storage="_regionName", FieldType="Text")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="RegionHREmployeeCode", Storage="_regionHREmployeeCode", FieldType="Number")]
		...
		/// Region HR Name
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="RegionHRName", Storage="_regionHRName", FieldType="Text")]
	...
	public partial class RemindersItem : Item {
		...
		private System.Nullable<double> _noOfRemindersSent;
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="NoOfRemindersSent", Storage="_noOfRemindersSent", FieldType="Number")]
		public System.Nullable<double> NoOfRemindersSent {
			get {
				return this._noOfRemindersSent;
			}
			set {
				if ((value != this._noOfRemindersSent)) {
					this.OnPropertyChanging("NoOfRemindersSent", this._noOfRemindersSent);
					this._noOfRemindersSent = value;
					this.OnPropertyChanged("NoOfRemindersSent");
				}
			}
		}
	}
	...
	public partial class SubAreasItem : Item {
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="PersonnelSubAreaCode", Storage="_personnelSubAreaCode", FieldType="Text")]
		...
		/// </summary>
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="SubPersonnelAreaText", Storage="_subPersonnelAreaText", FieldType="Text")]
	...
	/// Create a new folder.
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Folder", Id="0x0120", List="Reminders")]
	public partial class RemindersFolder : Folder {
	...
	public partial class TasksTask : Task {
		...
		private Microsoft.SharePoint.Linq.EntitySet<TasksTask> _tasksTask0;
		
		private Microsoft.SharePoint.Linq.EntitySet<TasksTask> _predecessors;
		...
		public TasksTask() {
			this._tasksTask0 = new Microsoft.SharePoint.Linq.EntitySet<TasksTask>();
			this._tasksTask0.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<TasksTask>>(this.OnTasksTask0Sync);
			this._tasksTask0.OnChanged += new System.EventHandler(this.OnTasksTask0Changed);
			this._tasksTask0.OnChanging += new System.EventHandler(this.OnTasksTask0Changing);
			this._predecessors = new Microsoft.SharePoint.Linq.EntitySet<TasksTask>();
			this._predecessors.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<TasksTask>>(this.OnPredecessorsSync);
		...
		[Microsoft.SharePoint.Linq.AssociationAttribute(Name="Predecessors", Storage="_tasksTask0", ReadOnly=true, MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Backward, List="Tasks")]
		public Microsoft.SharePoint.Linq.EntitySet<TasksTask> TasksTask0 {
			get {
				return this._tasksTask0;
			}
			set {
				this._tasksTask0.Assign(value);
			}
		}
		...
		public Microsoft.SharePoint.Linq.EntitySet<TasksTask> Predecessors {
			get {
		...
		private void OnTasksTask0Changing(object sender, System.EventArgs e) {
			this.OnPropertyChanging("TasksTask0", this._tasksTask0.Clone());
		}
		
		private void OnTasksTask0Changed(object sender, System.EventArgs e) {
			this.OnPropertyChanged("TasksTask0");
		}
		
		private void OnTasksTask0Sync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<TasksTask> e) {
			if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
		...
		private void OnPredecessorsSync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<TasksTask> e) {
			if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
				e.Item.TasksTask0.Add(this);
			}
			else {
				e.Item.TasksTask0.Remove(this);
			}
		}
	}
	...
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Web Part Page with Status List", Id="0x010100A2E3C117A0C5482FAEE3D57C48CB042F")]
	public partial class WebPartPageWithStatusList : Document {
		...
		public WebPartPageWithStatusList() {
			this.OnCreated();
		}
	...
	public partial class VFSAppraisalTasksTask : Task {
		...
		private Microsoft.SharePoint.Linq.EntitySet<VFSAppraisalTasksTask> _vFSAppraisalTasksTask0;
		
		private Microsoft.SharePoint.Linq.EntitySet<VFSAppraisalTasksTask> _predecessors;
		...
		public VFSAppraisalTasksTask() {
			this._vFSAppraisalTasksTask0 = new Microsoft.SharePoint.Linq.EntitySet<VFSAppraisalTasksTask>();
			this._vFSAppraisalTasksTask0.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<VFSAppraisalTasksTask>>(this.OnVFSAppraisalTasksTask0Sync);
			this._vFSAppraisalTasksTask0.OnChanged += new System.EventHandler(this.OnVFSAppraisalTasksTask0Changed);
			this._vFSAppraisalTasksTask0.OnChanging += new System.EventHandler(this.OnVFSAppraisalTasksTask0Changing);
			this._predecessors = new Microsoft.SharePoint.Linq.EntitySet<VFSAppraisalTasksTask>();
			this._predecessors.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<VFSAppraisalTasksTask>>(this.OnPredecessorsSync);
			this._predecessors.OnChanged += new System.EventHandler(this.OnPredecessorsChanged);
			this._predecessors.OnChanging += new System.EventHandler(this.OnPredecessorsChanging);
			this.OnCreated();
		}
		...
		[Microsoft.SharePoint.Linq.AssociationAttribute(Name="Predecessors", Storage="_vFSAppraisalTasksTask0", ReadOnly=true, MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Backward, List="VFSAppraisalTasks")]
		public Microsoft.SharePoint.Linq.EntitySet<VFSAppraisalTasksTask> VFSAppraisalTasksTask0 {
			get {
				return this._vFSAppraisalTasksTask0;
			}
			set {
				this._vFSAppraisalTasksTask0.Assign(value);
			}
		}
		...
		public Microsoft.SharePoint.Linq.EntitySet<VFSAppraisalTasksTask> Predecessors {
			get {
				return this._predecessors;
			}
			set {
		...
		private void OnVFSAppraisalTasksTask0Changing(object sender, System.EventArgs e) {
			this.OnPropertyChanging("VFSAppraisalTasksTask0", this._vFSAppraisalTasksTask0.Clone());
		}
		
		private void OnVFSAppraisalTasksTask0Changed(object sender, System.EventArgs e) {
			this.OnPropertyChanged("VFSAppraisalTasksTask0");
		}
		
		private void OnVFSAppraisalTasksTask0Sync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<VFSAppraisalTasksTask> e) {
			if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
				e.Item.Predecessors.Add(this);
			}
			else {
		...
		private void OnPredecessorsSync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<VFSAppraisalTasksTask> e) {
			if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
				e.Item.VFSAppraisalTasksTask0.Add(this);
			}
			else {
				e.Item.VFSAppraisalTasksTask0.Remove(this);
			}
		}
	}
	...
	public partial class WorkflowTasksTask : Task {
		...
		private Microsoft.SharePoint.Linq.EntitySet<WorkflowTasksTask> _workflowTasksTask0;
		
		private Microsoft.SharePoint.Linq.EntitySet<WorkflowTasksTask> _predecessors;
		...
		public WorkflowTasksTask() {
			this._workflowTasksTask0 = new Microsoft.SharePoint.Linq.EntitySet<WorkflowTasksTask>();
			this._workflowTasksTask0.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<WorkflowTasksTask>>(this.OnWorkflowTasksTask0Sync);
			this._workflowTasksTask0.OnChanged += new System.EventHandler(this.OnWorkflowTasksTask0Changed);
			this._workflowTasksTask0.OnChanging += new System.EventHandler(this.OnWorkflowTasksTask0Changing);
			this._predecessors = new Microsoft.SharePoint.Linq.EntitySet<WorkflowTasksTask>();
			this._predecessors.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<WorkflowTasksTask>>(this.OnPredecessorsSync);
			this._predecessors.OnChanged += new System.EventHandler(this.OnPredecessorsChanged);
			this._predecessors.OnChanging += new System.EventHandler(this.OnPredecessorsChanging);
			this.OnCreated();
		}
		...
		[Microsoft.SharePoint.Linq.AssociationAttribute(Name="Predecessors", Storage="_workflowTasksTask0", ReadOnly=true, MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Backward, List="Workflow Tasks")]
		public Microsoft.SharePoint.Linq.EntitySet<WorkflowTasksTask> WorkflowTasksTask0 {
			get {
				return this._workflowTasksTask0;
			}
			set {
				this._workflowTasksTask0.Assign(value);
			}
		}
		...
		public Microsoft.SharePoint.Linq.EntitySet<WorkflowTasksTask> Predecessors {
			get {
				return this._predecessors;
			}
			set {
		...
		private void OnWorkflowTasksTask0Changing(object sender, System.EventArgs e) {
			this.OnPropertyChanging("WorkflowTasksTask0", this._workflowTasksTask0.Clone());
		}
		
		private void OnWorkflowTasksTask0Changed(object sender, System.EventArgs e) {
			this.OnPropertyChanged("WorkflowTasksTask0");
		}
		
		private void OnWorkflowTasksTask0Sync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<WorkflowTasksTask> e) {
			if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
				e.Item.Predecessors.Add(this);
			}
			else {
		...
		private void OnPredecessorsSync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<WorkflowTasksTask> e) {
			if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
				e.Item.WorkflowTasksTask0.Add(this);
			}
			else {
				e.Item.WorkflowTasksTask0.Remove(this);
			}
		}
	}
	...
	/// Create a new wiki page.
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Wiki Page", Id="0x010108", List="V-Perform")]
	public partial class VPerformWikiPage : WikiPage {
	...
	/// Create a new wiki page.
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Wiki Page", Id="0x010108", List="V-Perform Wiki")]
	public partial class VPerformWikiWikiPage : WikiPage {
	...
	/// Upload an image or a photograph.
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Picture", Id="0x010102", List="V-Performwiki")]
	public partial class VPerformwikiPicture : Picture {
