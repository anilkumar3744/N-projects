...
namespace VFS.PMS.ImportDataFromSAPFiles {
	...
	public partial class VFSPMSEntitiesDataContext : Microsoft.SharePoint.Linq.DataContext {
		...
		public Microsoft.SharePoint.Linq.EntityList<VFSAppraisalTasksItem> VFSAppraisalTasks {
			get {
				return this.GetList<VFSAppraisalTasksItem>("VFSAppraisalTasks");
			}
		}
	}
	...
	[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(VFSAppraisalTasksItem))]
	...
	public partial class AppraisalCompetenciesItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="acmptDescription", Storage="_description", FieldType="Text")]
	...
	public partial class AppraisalGoalsItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="agGoal", Storage="_goal", FieldType="Text")]
		public string Goal {
			get {
				return this._goal;
			}
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="agGoalDescription", Storage="_goalDescription", FieldType="Text")]
	...
	public partial class CompetencyDescriptionsItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="cmptDescription", Storage="_description", Required=true, FieldType="Text")]
		public string Description {
			get {
				return this._description;
			}
	...
	public partial class TMTActionsItem : Item {
		...
		private string _isH1GoalSettingStarted0;
		
		private string _isH1SelfEvaluationStarted;
		
		private string _isH1SelfEvaluationStarted0;
		
		private string _isH2SelfEvaluationStarted;
		
		private string _isH2SelfEvaluationStarted0;
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="IsH1GoalSettingStarted", Storage="_isH1GoalSettingStarted0", FieldType="Text")]
		public string IsH1GoalSettingStarted0 {
			get {
				return this._isH1GoalSettingStarted0;
			}
			set {
				if ((value != this._isH1GoalSettingStarted0)) {
					this.OnPropertyChanging("IsH1GoalSettingStarted0", this._isH1GoalSettingStarted0);
					this._isH1GoalSettingStarted0 = value;
					this.OnPropertyChanged("IsH1GoalSettingStarted0");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="IsH1SelfEvaluationStarted", Storage="_isH1SelfEvaluationStarted", FieldType="Text")]
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="tmtIsH1SelfEvaluationStarted", Storage="_isH1SelfEvaluationStarted0", FieldType="Text")]
		public string IsH1SelfEvaluationStarted0 {
			get {
				return this._isH1SelfEvaluationStarted0;
			}
			set {
				if ((value != this._isH1SelfEvaluationStarted0)) {
					this.OnPropertyChanging("IsH1SelfEvaluationStarted0", this._isH1SelfEvaluationStarted0);
					this._isH1SelfEvaluationStarted0 = value;
					this.OnPropertyChanged("IsH1SelfEvaluationStarted0");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="IsH2SelfEvaluationStarted", Storage="_isH2SelfEvaluationStarted", FieldType="Text")]
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="tmtIsH2SelfEvaluationStarted", Storage="_isH2SelfEvaluationStarted0", FieldType="Text")]
		public string IsH2SelfEvaluationStarted0 {
			get {
				return this._isH2SelfEvaluationStarted0;
			}
			set {
				if ((value != this._isH2SelfEvaluationStarted0)) {
					this.OnPropertyChanging("IsH2SelfEvaluationStarted0", this._isH2SelfEvaluationStarted0);
					this._isH2SelfEvaluationStarted0 = value;
					this.OnPropertyChanged("IsH2SelfEvaluationStarted0");
				}
			}
		}
	...
	/// TMT Actions
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="VFS_TMTActionsCType", Id="0x010059F11DF1398B429498E2008E8CDA5580")]
	...
	/// Create a new list item.
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Item", Id="0x01", List="VFSAppraisalTasks")]
	public partial class VFSAppraisalTasksItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="tskAssignedTo", Storage="_assignedToId", FieldType="User", IsLookupId=true)]
		public System.Nullable<int> AssignedToId {
			get {
				return this._assignedToId;
			}
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="tskAssignedTo", Storage="_assignedTo", ReadOnly=true, FieldType="User", IsLookupValue=true)]
		public string AssignedTo {
			get {
				return this._assignedTo;
			}
	...
	/// TMT Actions
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="VFS_TMTActionsCType", Id="0x010059F11DF1398B429498E2008E8CDA5580", List="TMT Actions")]
	public partial class TMTActionsVFS_TMTActionsCType : VFS_TMTActionsCType {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="IsH1SelfEvaluationStarted", Storage="_isH1SelfEvaluationStarted0", FieldType="Text")]
		public string IsH1SelfEvaluationStarted0 {
			get {
				return this._isH1SelfEvaluationStarted0;
			}
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="IsH2SelfEvaluationStarted", Storage="_isH2SelfEvaluationStarted0", FieldType="Text")]
		public string IsH2SelfEvaluationStarted0 {
			get {
				return this._isH2SelfEvaluationStarted0;
			}
