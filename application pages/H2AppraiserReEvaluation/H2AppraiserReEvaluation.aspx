...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="H2AppraiserReEvaluation.aspx.cs"
    Inherits="VFS.PMS.ApplicationPages.Layouts.H2AppraiserReEvaluation.H2AppraiserReEvaluation"
...
<asp:content id="Main" contentplaceholderid="PlaceHolderMain" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="updatepanel">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btnPIPCancel" />
        </Triggers>
        <ContentTemplate>
            <div>
                    ...
                    <asp:Repeater ID="rptGoalSettings" runat="server"   >
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="td_lines Grid1">
                                    <SharePoint:DateTimeControl LocaleId="2057" runat="server" ID="SPDateLastDategoal"
                                        CssClassTextBox="datecss reqSPDateLastDate validation" DateOnly="true" />
                                </td>
                                <td class="td_lines Grid1" style="" align="center">
                                    <asp:TextBox runat="server" ID="txtWeightage" AutoPostBack="true" OnTextChanged="txtWeightage_TextChanged"
                                        ...
                                        onkeypress="return isNumberKeyW(event)" MaxLength="6" />
                                </td>
                                <td class="td_lines Grid1" style="" align="center">
                            ...
                            <tr>
                                ...
                                <td colspan="7" class="td_lines Grid1 " align="left">
                                    ...
                                    <asp:TextBox runat="server" ID="TxtAprComments" Text='<%#Eval("agAppraiserLatestComments") %>'
                                        TextMode="MultiLine" Width="99%" CssClass="MLTextbox  commentstextboxwidth" />
                                </td>
                            </tr>
                            <tr>
                ...
                <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                    ...
                    <asp:Repeater ID="RptDevelopmentMesure" runat="server">
                            ...
                            <tr>
                                ...
                                <td class="td_lines Grid1" colspan="4">
                                    ...
                                    <asp:TextBox runat="server" ID="TxtDevComments" Text='<%#Eval("pdpH2AppraiserComments") %>'
                                        TextMode="MultiLine" Width="99%" CssClass="MLTextbox" />
                                </td>
                            </tr>
                            <%-- <tr>
                        <td align="center" class="td_lines td_up" style="vertical-align: top;">
                        ...
                        <td class="td_lines Grid1" colspan="4">
                            ...
                            <asp:Label ID="LblReviwerComments" runat="server" />
                        </td>
                    </tr>--%>
                        </ItemTemplate>
                    </asp:Repeater>
                    ...
                    <asp:Repeater ID="rptpip" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center" class="td_lines Grid1" style="">
                                    <asp:LinkButton Text="Delete" ID="lnkDelete" OnClick="lnkPIPDelete_Click" CommandArgument='<%#Eval("SNo") %>'
                                        runat="server" />
                                </td>
                            </tr>
                        </ItemTemplate>
...
<asp:content id="PageTitle" contentplaceholderid="PlaceHolderPageTitle" runat="server">
    H2-Appraiser Re Evaluation Page
</asp:content>
