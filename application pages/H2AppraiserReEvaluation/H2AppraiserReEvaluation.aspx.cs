...
namespace VFS.PMS.ApplicationPages.Layouts.H2AppraiserReEvaluation
{
    public partial class H2AppraiserReEvaluation : LayoutsPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
                    {
                        using (SPWeb currentWeb = osite.OpenWeb())
                        {
                            ...
                            if (phaseItemH2["aphSignoffonbehalfcomments"] != null)
                            {
                                lblAppraiseeAppealFinalComments.Text = phaseItemH2["aphSignoffonbehalfcomments"].ToString();
                            }

                            string tabValue = Convert.ToString(Request.Params["TaskID"]);

                            #region Devloped by Krishna 240620130539
                            ...
                            if (!CommonMaster.CheckCurrentUserIsActor(this.currentUser, "H2 - Awaiting Appraiser Evaluation", Convert.ToInt32(hfAppraisalID.Value), currentWeb))
                            {
            ...
            catch (Exception ex)
            {
                ...
                LogHandler.LogError(ex, "Error in PMS Appraiser RE Evaluation");
        ...
        private void BindDateTimeControl(string last)
        {
            ...
            {
                LogHandler.LogError(ex, "Error in PMS Appraiser ReEvaluation H2");
                Context.Response.Write("<script type='text/javascript'> " + CommonMaster.serializeMessage(ex.Message) + ";</script>");
            }
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                SPSecurity.RunWithElevatedPrivileges(delegate()
                {
                    ...
                    string url = SPContext.Current.Web.Url + "/_layouts/H2AppraiserReEvaluation/H2AppraiserReEvaluation.aspx?AppId=" + hfAppraisalID.Value;
            ...
            {
                LogHandler.LogError(ex, "Error in PMS Appraiser ReEvaluation_Save H2");
                Context.Response.Write("<script type='text/javascript'> " + CommonMaster.serializeMessage(ex.Message) + ";</script>");
            }
            ...
            using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
            {
                using (SPWeb objWeb = osite.OpenWeb())
                {
                    ...
                    foreach (RepeaterItem item in rptGoalSettings.Items)
                    {
                        ...
                        DateTimeControl dc = item.FindControl("SPDateLastDategoal") as DateTimeControl;//upendra change the label
                        ...
                        //SPListItemCollection phasesCollection = lstAppraisalPhases.GetItems(q);  //
                        ...
                        lstItem["aphScore"] = Convert.ToString(lblH2Score.Text);
            ...
            using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
            {
                using (SPWeb oWeb = osite.OpenWeb())
                {
                    ...
                    foreach (RepeaterItem item in RptDevelopmentMesure.Items)
                    {
                        ...
                        Label lblAppraise = item.FindControl("lblAppraise") as Label;  // pdpH2AppraiseeComments
                        ...
                        //Label lblNextSteps = item.FindControl("txtNextSteps") as Label;
                        ...
                        if (!string.IsNullOrEmpty(Convert.ToString(TxtDevComments)))
                            CurrentListItem["pdpH2AppraiserComments"] = TxtDevComments.Text;
        ...
        protected void BtnApprove_Click(object sender, EventArgs e)
        {
            ...
            {
                LogHandler.LogError(ex, "Error in PMS Appraiser ReEvaluation_Approve H2");
                Context.Response.Write("<script type='text/javascript'> " + CommonMaster.serializeMessage(ex.Message) + ";</script>");
            }
        }
        ...
        protected void LnkDelete_Click(object sender, EventArgs e)
        {
            ...
            //decimal finalValue = (Convert.ToDecimal(total) + Convert.ToDecimal(LblH1score1.Text)) / 2;
            decimal finalValue;
            if (!string.IsNullOrEmpty(LblH1score1.Text))
            {
        ...
        protected void LnkDetails_Click(object sender, EventArgs e)
        {
            ...
            // Response.Redirect(SPContext.Current.Site.Url + "_Layouts/H1AppraiserReEvaluation/H1AppraiserReEvaluation.aspx");
        }
        ...
        private void ScoreFinal(int appraisalID)
        {
            using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
            {
                using (SPWeb objWeb = osite.OpenWeb())
                {
                    ...
                    lstItem = lstAppraisalPhases.GetItemById(appraisalID);
        ...
        protected void rptGoalSettingsItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                dc = ritem.FindControl("SPDateLastDategoal") as DateTimeControl;
