...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppraiserPIPEdit.aspx.cs"
    Inherits="VFS.PMS.ApplicationPages.Layouts.VFSApplicationPages.AppraiserPIPEdit"
...
<asp:content id="Main" contentplaceholderid="PlaceHolderMain" runat="server">
    ...
    <div runat="server" id="divPIP" visible="false">
        ...
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
            ...
            <asp:Repeater ID="rptPIP" runat="server">
                <HeaderTemplate>
                    <tr class="GridHead">
                        <td align="center" class="td_lines " style="width:4%;">
                            <asp:Label Text="S.No" runat="server" ID="lblSno" />
                        </td>
                        <td align="center" class="td_lines" style="width:13%;">
                        ...
                        <td align="center" class="td_lines" runat="server" id="tdResultMT" style="width:13%;">
                            <asp:Label Text="Actual Result (Mid Term)" runat="server" ID="lblActualResult"/>
                        </td>
                        <td align="center" class="td_lines" runat="server" id="tdAssessmentMT" style="width:13%;">
                            <asp:Label Text="Appraiser Assessment(Mid Term)" runat="server" ID="lblAppraisersAssessment"/>
                        </td>
                        <td align="center" class="td_lines" runat="server" id="tdResultFT" style="width:13%;">
                            <asp:Label Text="Actual Result (Final)" runat="server" ID="lblFActualResult"/>
                        </td>
                        <td align="center" class="td_lines" runat="server" id="tdAssessmentFT" style="width:13%;">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center" class="td_lines Grid1" style="">
                            ...
                            <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipPerformanceIssue") %>' ID="txtPerformanceIssu" Rows="4" CssClass="PIPMandatory performance"
                                runat="server" Width="99%" />
                        </td>
                        <td align="center" class="td_lines Grid1" style="">
                            <asp:Label Text='<%#Eval("pipExpectedachivement") %>' CssClass="Grid1" ID="lblExpectedAchivements"
                                runat="server" Visible="false" />
                            <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipExpectedachivement") %>' ID="txtExpectedAchivements" Rows="4" CssClass="PIPMandatory achivement"
                                runat="server" Width="99%" />
                        </td>
                        <td align="center" class="td_lines Grid1" style="">
    ...
    <div>
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
            ...
            <%--  <tr>
            <td class="Grid1">
                <asp:Label Text="Comments:" ID="lblComm" runat="server" /><br />              
