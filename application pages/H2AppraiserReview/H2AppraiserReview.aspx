...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="H2AppraiserReview.aspx.cs"
    Inherits="VFS.PMS.ApplicationPages.Layouts.H2AppraiserReview.H2AppraiserReview"
...
//            var text = $('.PIPMandatory').text();

//            if (text == '') {
//                alert('Please enter Performance Issue');
//                $('.PIPMandatory').focus();
//                return false;
//            }
//            var text = $('.PIPMandatory2').text();

//            if (text == '') {
//                alert('Please enter Expected Achivement');
//                $('.PIPMandatory2').focus();
//                return false;
//            }
//            var text = $('.PIPMandatory3').text();
...
<asp:content id="Main" contentplaceholderid="PlaceHolderMain" runat="server">
        ...
        function Validate() {
            ...
            if (flag1 == 0) {
                ...
                $('.ExpectedResult').each(function (i, obj) {
                    ...
                    else if ($(this).hasClass("AppraiseeLatestComments") && obj.value == '') {
    ...
    <asp:UpdatePanel ID="Updatepanel" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="td_lines Grid1" style="" align="center">
                                    ...
                                    <asp:TextBox runat="server" ID="txtWeightage" AutoPostBack="true" OnTextChanged="txtWeightage_TextChanged"
                                        CssClass="Textbox condtional_box validation" Width="40%" Text='<%#Eval("agWeightage") %>' onkeypress="return isNumberKeyW(event)" />
                                    <%-- <asp:CompareValidator ID="CV" runat="server" ControlToValidate="txtWeightage" Type="Double" Operator="DataTypeCheck"
                                        ErrorMessage="Please Enter Whole Numbers"></asp:CompareValidator>--%>
                                </td>
                                <td class="td_lines Grid1" style="" align="center">
                                    ...
                                    <asp:TextBox runat="server" ID="TxtEvaluation" CssClass="Textbox Evaluation validation"
                                        Width="40%" AutoPostBack="true" OnTextChanged="txtWeightage_TextChanged" Text='<%#Eval("agEvaluation") %>'
                                        onkeypress="return isNumberKey(event)" MaxLength="6" />
                                    <%-- <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="TxtEvaluation" Type="Double" Operator="DataTypeCheck"
                                        ErrorMessage="Please Enter Whole Numbers"></asp:CompareValidator>--%>
                                </td>
                                <td class="td_lines Grid1" style="" align="center">
                            ...
                            <tr>
                                ...
                                <td colspan="7" class="td_lines Grid1 " align="left">
                                    ...
                                    <asp:TextBox runat="server" ID="txtDescription" Text='<%#Eval("agGoalDescription") %>'
                                        TextMode="MultiLine" Columns="71" Width="99%" CssClass="MLTextbox validation reqtxtDescription" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="7" class="td_lines Grid1" align="left">
                                    ...
                                    <asp:Label ID="LblReviewerComments" Text='<%#Eval("agReviewerLatestComments") %>'
                                        CssClass="comments1" runat="server" />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                ...
                <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                            ...
                            <tr>
                                ...
                                <td class="td_lines Grid1" colspan="7">
                                    ...
                                    <asp:TextBox runat="server" TextMode="MultiLine " Text='<%#Eval("acmptAppraiserLatestComments") %>'
                                        ID="TxtAppraisercmts" CssClass="MLTextbox ExpectedResult AppraiseeLatestComments" Width="99%" />
                                </td>
                            </tr>
                            <tr>
                                <td align="center" class="td_lines td_up" style="vertical-align: top;">
                    ...
                    <%--<tr>
                        <td class="Grid1" colspan="5">
                            ...
                            <asp:Label ID="Label4" Text="Comments" runat="server" />
                        </td>
                    </tr>--%>
                </table>
            </div>
                ...
                <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                    ...
                    <%--<tr>
                        <td class="Grid1" colspan="5">
                            ...
                            <asp:Label ID="LblCmts2" Text="Comments" runat="server" />
                        </td>
                    </tr>--%>
                </table>
            </div>
            <div runat="server" id="pipdiv" style="display:none">
        ...
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center" class="td_lines Grid1" style="">
                            ...
                            <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipPerformanceIssue") %>' CssClass="PIPMandatory performance" ID="txtPerformanceIssu"
                                runat="server" Width="99%" Rows="4"/>
                        </td>
                        <td align="center" class="td_lines Grid1" style="">
                            <asp:Label Text='<%#Eval("pipExpectedachivement") %>' CssClass="Grid1" ID="lblExpectedAchivements"
                                runat="server" Visible="false" />
                            <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipExpectedachivement") %>' CssClass="PIPMandatory achivement" ID="txtExpectedAchivements"
                                runat="server" Width="99%" Rows="4"/>
                        </td>
                        <td align="center" class="td_lines Grid1" style="">
                            <asp:Label Text='<%#Eval("pipTimeFrame") %>' ID="lblTimeFrame" CssClass="Grid1" runat="server"
                                Visible="false" />
                            <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipTimeFrame") %>' CssClass="PIPMandatory TimeFrame" ID="txtTimeFrame"
                                runat="server" Width="99%" Rows="4"/>
                        </td>
                        <td align="center" class="td_lines Grid1" style="">
                            ...
                            <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipMidTermActualResult") %>' ID="txtActualResultmidterm"
                                runat="server" Width="99%" Visible="false" Rows="4"/>
                        </td>
                        <td align="center" class="td_lines Grid1" style="">
                            ...
                            <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipMidTermAppraisersAssessment") %>'
                                ID="txtAppraisersAssessmentmidterm" runat="server" Visible="false" Width="99%" Rows="4"/>
                        </td>
                        <td align="center" class="td_lines Grid1" style="">
                            ...
                            <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipFinalAcutualResult") %>' ID="txtActualResultfinelterm"
                                runat="server" Visible="false" Width="99%" Rows="4"/>
                        </td>
                        <td align="center" class="td_lines Grid1" style="">
                            ...
                            <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipFinalAppraisersAssesment") %>'
                                ID="txtAppraisersAssessmentfinalterm" runat="server" Visible="false" Width="99%" Rows="4"/>
                        </td>
                        <td align="center" class="td_lines Grid1" style="">
            ...
            <tr>
                <td align="right" class="td_lines td_up" colspan="9">
                    <asp:Button Text="Submit" ID="lnksave" OnClick="lnkSave_Click" runat="server" CssClass="Button" OnClientClick = "return ValidatePIP();"/>
        ...
        <td class="Grid1" colspan="5">
                    ...
                    <tr>
                        <td colspan="8" align="right" class="td_lines td_bottom Grid1"">
                            ...
                            <asp:Button Text="Submit" ID="btnSubmit" OnClientClick="return Validate()" runat="server"
