...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignOff.aspx.cs" Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH1.SignOff" DynamicMasterPageFile="~masterurl/default.master" %>
    ...
    <div>
        <table cellpadding="7px" cellspacing="2px"  width="100%" style="border: 1px solid;
            ...
            <td class="Grid1">
                ...
                <asp:Label Text='<%#Eval("ID") %>' Visible="false" runat="server" ID="lblCId" />
            ...
            <tr>
                <td align="right" class="td_lines td_up Grid1" >
                    ...
                    <asp:Button Text="SignOff" ID="btnSignOff" runat="server" OnClick="BtnSignoff_Click"  CssClass="Button" />
