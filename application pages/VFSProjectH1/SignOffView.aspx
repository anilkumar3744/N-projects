...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignOffView.aspx.cs" Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH1.SignOffView" DynamicMasterPageFile="~masterurl/default.master" %>
...
<script type="text/javascript" src="/_layouts/Scripts/jquery-1.9.0.min.js"> </script>
            ...
            <tr class="TableHeader">
                ...
                <td align="right" style="padding-right: 4px;">
                   <%-- <h3 style="margin-top: 3px;">--%>
                        ...
                        &nbsp;&nbsp;
                        <asp:Label runat="server" ID="lblStatusValue" Text="H1- Appraisee Sign-Off" class="TableHeader_1"></asp:Label>
                   <%-- </h3>--%>
                </td>
            </tr>
        </table>
    ...
    <div>
        <table cellpadding="7px" cellspacing="2px"  width="100%" style="border: 1px solid;
            ...
            <tr>
            <td class="Grid1">
                <asp:Label Text="Appraisee Comments:" ID="lblComm" runat="server" /><br />
