...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRView.aspx.cs" Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH1.HRView"
    ...
    <div runat="server" id="pipdiv">
        ...
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
            ...
            <asp:Repeater ID="rptpip" runat="server">
                <HeaderTemplate>
                    <tr class="GridHead gridHeadRowHeight">
                    ...
                    <asp:GridView ID="gvCommentsHistory" runat="server" AutoGenerateColumns="false" HeaderStyle-Font-Bold="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Comment for" ItemStyle-Width="150px">
                                <ItemTemplate>
                                    <asp:Label ID="lblNumberScale" Text='<%#Eval("chCommentFor") %>' CssClass="Grid1"
                                        runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="By" ItemStyle-Width="100px">
                                <ItemTemplate>
                                    <asp:Label ID="lblNumberScale" Text='<%#Eval("chCommentedBy") %>' CssClass="Grid1"
                                        runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
