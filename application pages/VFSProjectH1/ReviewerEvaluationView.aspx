...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReviewerEvaluationView.aspx.cs" Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH1.ReviewerEvaluationView" DynamicMasterPageFile="~masterurl/default.master" %>
                ...
                <ItemTemplate>
                    ...
                    <tr>
                        ...
                        <td class="td_lines Grid1" colspan="7">
                            ...
                            <asp:Label ID="lblReviewerComments" Text='<%#Eval("agReviewerLatestComments")%>' runat="server"></asp:Label>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
