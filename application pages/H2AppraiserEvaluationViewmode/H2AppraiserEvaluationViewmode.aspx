...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="H2AppraiserEvaluationViewmode.aspx.cs"
    Inherits="VFS.PMS.ApplicationPages.Layouts.H2AppraiserEvaluationViewmode.H2AppraiserEvaluationViewmode"
        ...
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                ...
                <ItemTemplate>
                    ...
                    <tr>
                        ...
                        <td colspan="7" class="td_lines Grid1 " align="left">
                            ...
                            <asp:Label runat="server" ID="lblAppraiseeComments1" Text='<%#Eval("agAppraiseeLatestComments") %>' CssClass="comments1"></asp:Label>
                        </td>
                    </tr>
                    <tr>
            ...
            <tr>
                ...
                <td align="right" colspan="6" class="td_lines Grid1">
                    <asp:Label ID="LblH1score"  Text="H1 Score" runat="server"></asp:Label>
                </td>
                <td align="center" class="td_lines" colspan="2">
            ...
            <tr>
                <td align="right" class="td_lines td_up" colspan="9">
                    ...
                    <%--<asp:Button Text="Submit" ID="lnkapprove" OnClick="lnkapprove_Click" runat="server"
                        CssClass="Button" />--%>
                    <asp:Button Text="Cancel" ID="Button10" OnClick="lnkPIPDelete_Click" runat="server" CssClass="Button" />
                </td>
            </tr>
        </table>
    </div>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="8" align="right" class="td_lines td_bottom Grid1"">
                 <asp:Button Text="Print" ID="btnPrint" CssClass="Button"  runat="server" />
...
<asp:content id="PageTitle" contentplaceholderid="PlaceHolderPageTitle" runat="server">
    H2-Appraiser EvaluationView Page
</asp:content>
