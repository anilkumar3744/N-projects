...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AmmendGoals.aspx.cs" Inherits="VFS.PMS.ApplicationPages.Layouts.VFS_ApplicationPages.AmmendGoals"
...
<asp:content id="Main" contentplaceholderid="PlaceHolderMain" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Validate() {
           ...
           // alert(('.validation').length);
            ...
            var IsAppraiser = document.getElementById('<%=hfldIsAppraiser.ClientID%>').value; //$("#hfldIsAppraiser").val=="true"
            if (flag1 && IsAppraiser == "true") {
    ...
    <asp:HiddenField ID="hfAppraisee" Value="false" runat="server" />
    <asp:HiddenField ID="hfldMandatoryGoalCount" runat="server" />
    <asp:HiddenField ID="hfldIsAppraiser" Value="false"  runat="server"/>
    ...
    <div runat="server" id="dvGoalSettings">
        ...
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="td_lines Grid1">
                            ...
                            <SharePoint:DateTimeControl runat="server" LocaleId="2057" ID="SPDateLastDate" CssClassTextBox="datecss reqSPDateLastDate validation"
                                DateOnly="true" />
                        </td>
                        <td class="td_lines Grid1" style="" align="center">
                            ...
                            <asp:TextBox runat="server" ID="txtWeightage" CssClass="Textbox condtional_box validation"
                                Width="40%" Text='<%#Eval("agWeightage") %>' MaxLength="3" />
                        </td>
                        <td class="td_lines Grid1">
            ...
            <tr>
                <td colspan="6">
                    <asp:Label Text="Appraisee Comments:" ID="lblAppraiseeCommentsHeader1" CssClass="comments1"
                        runat="server" />
                    <asp:Label Text="Comments:" ID="lblAppraiseeCommentsHeader" CssClass="comments1"
                        runat="server" />
                    <br />
                    <asp:Label runat="server" ID="lblAppraiseeComments1" CssClass="Grid1"></asp:Label>
                    <asp:TextBox runat="server" ID="txtAppraiseeComments" TextMode="MultiLine" Width="99%"
                        CssClass="MLTextbox  commentstextboxwidth" />
                </td>
            </tr>
            <tr>
                <td colspan="6" style="height:100px;overflow:auto;">
                    <asp:Label ID="lblAppraiserCommentsHeader1" Text="Comments:" runat="server" CssClass="comments1" />
                    <asp:Label ID="lblAppraiserCommentsHeader" Text="Appraiser Comments:" runat="server"
                        CssClass="comments1" />
                    <br />
                    <asp:Label ID="lblAppraiserComments" Text="Comments" runat="server" CssClass="comments1 Grid1" />
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="left" class="td_lines Grid1">
                            ...
                            <asp:Label runat="server" ID="lblDescriptionValue1" Text='<%#Eval("acmptDescription") %>' />
                        </td>
                        <td class="td_lines Grid1 serial_numbers" align="center">
                            <asp:Label runat="server" ID="lblexectedresult" Text='<%#Eval("acmptExpectedResult") %>' />
                            <asp:DropDownList runat="server" ID="ddlExpectedResult" Visible="false" CssClass="ExpectedResult">
        ...
        <tr>
            <td colspan="6" align="right">
             <asp:Button Text="Print" ID="btnPrint" CssClass="Button"  runat="server" OnClientClick="printCert();return false;"  />
                ...
                <asp:Button Text="Approve" ID="btnApprove" Visible="false" OnClientClick="return Validate()" runat="server" OnClick="BtnApprove_Click"
                    CssClass="Button" />
                <asp:Button Text="Submit" ID="btnSubmit" Visible="false" runat="server" OnClick="BtnSubmit_Click"
