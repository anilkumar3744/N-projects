...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppraiseeSavedDraft.aspx.cs"
    Inherits="VFS.PMS.ApplicationPages.Layouts.VFS_ApplicationPages.AppraiseeSavedDraft"
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <asp:HiddenField ID="hfldMandatoryGoalCount" runat="server" />
     <asp:HiddenField ID="hfDraft" value="true" runat="server" />
