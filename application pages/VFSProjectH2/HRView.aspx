...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRView.aspx.cs" Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH2.HRView" DynamicMasterPageFile="~masterurl/default.master" %>
...
<script type="text/javascript" src="/_layouts/Scripts/jquery-1.9.0.min.js"> </script>
            ...
            <tr class="TableHeader">
                ...
                <td align="right" style="padding-right: 4px;">
                  <%--  <h3 style="margin-top: 3px;">--%>
                        ...
                        &nbsp;&nbsp;
                        <asp:Label runat="server" ID="lblStatusValue" Text="H2- Completed" class="TableHeader_1"></asp:Label>
                    <%--</h3>--%>
                </td>
            </tr>
        </table>
                    ...
                    <tr>
                        <td align="center">
                            <asp:GridView ID="gvCommentsHistory" runat="server" AutoGenerateColumns="false" HeaderStyle-Font-Bold="true"
                                ...
                                PageSize="10">
                                <HeaderStyle  Height="28px" CssClass="GridHead" />
                                <Columns>
    ...
    <div>
        <table cellpadding="7px" cellspacing="2px"  width="100%" style="border: 1px solid;
            ...
            <tr>
            <td class="Grid1">
                <asp:Label Text="HR Comments:" ID="lblComm" runat="server" />
                <asp:Label  ID="lblFinalComments" runat="server" />
            </td>
            </tr>
            <tr>
                <td align="right" class="td_lines td_up Grid1" >
                    ...
                    <asp:Button Text="Print" ID="btnPrint" OnClientClick="printCert();return false;" runat="server"  CssClass="Button" />
