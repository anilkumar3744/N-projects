...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReviewerEvaluation.aspx.cs"
    Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH2.ReviewerEvaluation" DynamicMasterPageFile="~masterurl/default.master" %>
...
//                }
        ...
        //            $(".Evaluation").keypress(function (event) {
        ...
        function Validate() {
           ...
           // alert($('.validation').length);
            $('.validation').each(function (i, obj) {
                    ...
                    else if ($(this).hasClass("reviwewercommnets")) {
                ...
                row = parseInt(i / 3) + 1;
                    if ($(this).prop("selectedIndex") == 0) {
                        ...
                        if ($(this).hasClass("Rating")) {
                            ...
                            alert('Please select Result for the Competency at row: ' + row);
                            $(this).focus();
                            flag2++;
                            return false;
                        }
                    ...
                    else if ($(this).hasClass("ReviewerLatestComments") && obj.value.trim() == '') {
    ...
    <Triggers>
     <asp:PostBackTrigger ControlID="btnAdd" />
        ...
        <ContentTemplate>
                        ...
                        <HeaderTemplate>
                            <tr class="GridHead">
                                ...
                                <td align="center" class="td_lines" style="width: 10%;">
                                    <asp:Label Text="Score" runat="server" ID="lblScore2" />
                                </td>
                                <td align="center" class="td_lines" style="width: 10%;">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="td_lines Grid1" style="" align="center">
                                    ...
                                    <asp:TextBox runat="server" ID="txtWeightage" 
                                        Width="40%" AutoPostBack="true" OnTextChanged="txtWeightage_TextChanged" Text='<%#Eval("agWeightage") %>' CssClass="Textbox condtional_box validation" MaxLength="4" onkeypress="return isNumberKeyW(event)" /> <%--condtional_box validation--%>
                                </td>
                                <td class="td_lines Grid1" style="" align="center">
                            ...
                            <tr>
                                ...
                                <td class="td_lines Grid1" colspan="7">
                                    ...
                                    <asp:TextBox runat="server" ID="txtComments" TextMode="MultiLine" Width="99%" Text='<%#Eval("agReviewerLatestComments")%>'
                                        CssClass="MLTextbox " /> <%--reviwewercommnets validation--%>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="td_lines rating1" align="center">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlrating" CssClass="competeniciesValidations Rating" AutoPostBack="true"> <%--OnSelectedIndexChanged="ddlrating_SelectedIndexChanged"--%>
                                        <asp:ListItem Text="Select" />
                                        <asp:ListItem Text="Good" />
                                        <asp:ListItem Text="Fair" />
                                        <asp:ListItem Text="Poor" />
                                    ...
                                    <td class="td_lines Grid1" colspan="7">
                                        <asp:Label Text="Comments" ID="LblComments" runat="server" />
                                         <asp:TextBox runat="server" TextMode="MultiLine" ID="txtComments" Text='<%#Eval("acmptReviewerLatestComments")%>'
                                            CssClass="MLTextbox " Width="99%" /> <%--ReviewerLatestComments competeniciesValidations--%>
                                    </td>
                                </tr>
                        </ItemTemplate>
                    </asp:Repeater>
            ...
            <div runat="server" id="pipdiv" visible="true">
