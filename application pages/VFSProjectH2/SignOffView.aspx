...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignOffView.aspx.cs" Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH2.SignOffView" DynamicMasterPageFile="~masterurl/default.master" %>
   ...
   <div>
            ...
            <tr class="TableHeader">
                <td>
                    <h3 style="margin-top: 3px; margin-left: 10px;">
                        <asp:Label runat="server" Text="Performance Agreement for:  " ID="lblHeader"></asp:Label>&nbsp;&nbsp;
                        <asp:Label runat="server" ID="lblHeaderValue"></asp:Label>
                    </h3>
                </td>
                <td align="right" style="padding-right: 4px;">
                    <h3 style="margin-top: 3px;">
                        <asp:Label runat="server" Text="Workflow State:" ID="lblStatus"></asp:Label>
                        &nbsp;&nbsp;
                        <asp:Label runat="server" ID="lblStatusValue" Text="H2- Sign-Off by Appraisee"></asp:Label>
                    </h3>
                </td>
            </tr>
        </table>
    ...
    <div>
        <table cellpadding="7px" cellspacing="2px"  width="100%" style="border: 1px solid;
            ...
            <tr>
            <td class="Grid1">
                <asp:Label Text="Appraisee Comments:" ID="lblComm" runat="server" />
