...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignOff.aspx.cs" Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH2.SignOff" DynamicMasterPageFile="~masterurl/default.master" %>
...
<script type="text/javascript" src="/_layouts/Scripts/jquery-1.9.0.min.js"> </script>
    ...
    <asp:HiddenField ID="HRLog" runat="server" />
    <div>
            ...
            <tr class="TableHeader">
                ...
                <td align="right" style="padding-right: 4px;">
                 <%--   <h3 style="margin-top: 3px;">--%>
                        ...
                        &nbsp;&nbsp;
                        <asp:Label runat="server" ID="lblStatusValue" Text="H2- Awaiting Appraisee Sign-Off" class="TableHeader_1"></asp:Label>
                   <%-- </h3>--%>
                </td>
            </tr>
        </table>
        ...
        <table cellpadding="7px" cellspacing="0px" width="100%" class="" style="">
            ...
            <tr>
                ...
                <td class="FieldCell FieldCell2">
                    <asp:LinkButton Text="View H1 Details" ID="lnkView" runat="server" OnClientClick="javascript:return OpenDialog();" />
                </td>
            </tr>
        </table>
    </div>
                ...
                <HeaderTemplate>
                    <tr class="GridHead">
                        ...
                        <td align="center" class="td_lines" style="width: 10%;">
                            <asp:Label Text="Score (%)" runat="server" ID="lblScoreA" />
                        </td>
                        <td align="center" class="td_lines" style="width: 10%;">
                    ...
                    <tr>
                        ...
                        <td class="td_lines Grid1" style="" align="center">
                            ...
                            <td class="td_lines Grid1" style="" align="center">
                                ...
                                <asp:TextBox runat="server" ID="txtScore" Text='<%#Eval("agScore") %>' CssClass="Textbox" Width="50%" Visible="false" />
                            </td>
                            <td class="td_lines">
        ...
        <table cellpadding="7px" cellspacing="2px"  width="100%" style="border: 1px solid;
            ...
            <tr>
                <td align="right" class="td_lines td_up Grid1" >
                    ...
                    <asp:Button Text="SignOff" ID="btnSignOff" OnClick="BtnSignoff_Click" runat="server" CssClass="Button" />
                    <asp:Button Text="Appeal" ID="btnAppeal" runat="server"  OnClick="BtnAppeal_Click" OnClientClick="return Validate()" CssClass="Button" />
                    <asp:Button Text="Cancel" ID="btnCancel" runat="server" OnClick="BtnCancel_Click" CssClass="Button" />
                </td>
            </tr>
        </table>
    </div>
    <asp:Panel runat="server" ID="coc" Visible="false"> 
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="Grid"
            style="padding: 0px; border: 1px solid;">
            <tr>
                <td align="center" style="font-size: large;" colspan="2">
                    <asp:Label Text=" Code of Conduct " ID="l1" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="Grid1">
                    <asp:Label ID="Label1" Text="I here with confirmed that I have read and taken due note of the VFS Code of Conduct."
                        runat="server" /><br />
                        <asp:Label ID="Label2" Text="The document is available on the intranet,server or on the internet or in the hard copy with local HR."
                        runat="server" /><br />
                        <asp:Label ID="Label3" Text="I agree with the content and I know that I could address in any case either my line manager,local HR or the Compliance officer."
                        runat="server" />
                </td>
            </tr>
            <tr>
            <td align="right">
                ...
                <asp:Button Text="Submit" ID="btnSubmit" OnClick="BtnSubmit_Click" runat="server" CssClass="Button" />
                <asp:Button Text="Cancel" ID="btnCncl" OnClick="BtnCancelFinal_Click" runat="server" CssClass="Button" />
            </td>
            </tr>
            <tr><td></td></tr>
        </table>
