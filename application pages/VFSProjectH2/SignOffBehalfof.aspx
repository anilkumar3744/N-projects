...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignOffBehalfof.aspx.cs" Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH2.SignOffBehalfof" DynamicMasterPageFile="~masterurl/default.master" %>
        ...
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
          ...
          <%--  <tr>
            ...
            <tr>
                ...
                <td align="center" class="td_lines" colspan="2">
                    <asp:Label Text="" ID="lblFS" runat="server" />
                </td>
            </tr>
            <tr>
                <td align="right" colspan="6" class="td_lines Grid1">
