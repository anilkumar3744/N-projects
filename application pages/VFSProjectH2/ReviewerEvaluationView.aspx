...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReviewerEvaluationView.aspx.cs"
    Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH2.ReviewerEvaluationView"
...
<asp:content id="Main" contentplaceholderid="PlaceHolderMain" runat="server">
        ...
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                    ...
                    <tr>
                        ...
                        <td class="td_lines Grid1" style="" align="center">
                            ...
                            <td class="td_lines Grid1" style="" align="center">
                                ...
                                <asp:TextBox runat="server" ID="txtScore" Text="70" CssClass="Textbox" Width="50%"
                                    Visible="false" />
                            </td>
                            <td class="td_lines">
            ...
            <tr>
                ...
                <td align="center" class="td_lines" colspan="2">
                    <asp:Label  ID="lblScoretotal" Text='<%#Eval("aphScore")%>' runat="server" />
                </td>
            ...
            <tr>
                ...
                <td align="center" class="td_lines" colspan="2">
                    <asp:Label Text="" ID="lblscore" runat="server" />
                </td>
            </tr>
            <tr>
                <td align="right" colspan="6" class="td_lines Grid1">
    ...
    <div>
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
            ...
            <tr>
                <td align="right" class="td_lines td_up">
