...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRDecisions.aspx.cs" Inherits="VFS.PMS.ApplicationPages.Layouts.VFSProjectH2.HRDecisions" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
 <script type="text/javascript" src="/_layouts/Scripts/jquery-1.9.0.min.js"> </script>
            ...
            <tr class="TableHeader">
                ...
                <td align="right" style="padding-right: 4px;">
                   <%-- <h3 style="margin-top: 3px;">--%>
                        ...
                        &nbsp;&nbsp;
                        <asp:Label runat="server" ID="lblStatusValue" Text="H2- Sign-Off by Appraisee" class="TableHeader_1"></asp:Label>
                  <%--  </h3>--%>
                </td>
            </tr>
        </table>
    ...
    <div class="tabs">
        <asp:TabContainer ID="TabContainer1" runat="server" AutoPostBack="true">
            ...
            <asp:TabPanel ID="tbpnljobdetails" runat="server">
             ...
             <asp:TabPanel ID="tbpnlCHistory" runat="server">
                <HeaderTemplate>
                    Comments History
                </HeaderTemplate>
                <ContentTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="td_lines Grid1" style="" align="center">
                            ...
                            <td class="td_lines Grid1" style="" align="center">
                                <asp:Label runat="server" ID="lblScore" Text='<%#Eval("agScore") %>' />
                            </td>
                            <td class="td_lines">
    ...
    <div runat="server" id="saftymeasurementdevelopment">
        ...
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
            ...
            <asp:Repeater ID="rptsaftymeasurementdevelopment" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center" class="td_lines Grid1 td_bottom verticalalign serial_numbers">
                            <asp:Label Text='<%#Eval("SNo") %>' runat="server" ID="lblSno" />
    ...
    <div runat="server" id="dvCHistory" visible="false">
    <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid class="Grid";>
                    <tr>
                        <td align="center">
                            <asp:GridView ID="gvCommentsHistory" runat="server" AutoGenerateColumns="false" HeaderStyle-Font-Bold="true"
                                AllowPaging="true" OnPageIndexChanging="gvCommentsHistory_PageIndexChanging" AlternatingRowStyle-CssClass="GridAlt gridRowHeight"
                                PageSize="10">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Comment for" ItemStyle-Width="250px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNumberScale" Text='<%#Eval("chCommentFor") %>' CssClass="Grid1" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Comments" ItemStyle-Width="300px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNumberScale" Text='<%#Eval("chComment") %>' CssClass="Grid1" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="By" ItemStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNumberScale" Text='<%#Eval("chCommentedBy") %>' CssClass="Grid1" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Role" ItemStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNumberScale" Text='<%#Eval("chRole") %>' CssClass="Grid1" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Commented On" ItemStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNumberScale" Text='<%# Convert.ToDateTime(Eval("chCommentedDate")).ToString("dd-MMM-yyyy")%>' CssClass="Grid1" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
    ...
    <div>
        <table cellpadding="7px" cellspacing="2px"  width="100%" style="border: 1px solid;
            border-collapse: collapse; padding-right: 5px;border-top:none;">
             ...
             <td class="Grid1">
             <asp:Label Text="Appraisee Sign-Off Comments:" ID="lblSignComm" runat="server" />
             <asp:Label  ID="lblSignOffComments" runat="server" />
           </td>
            <tr>
            <td class="Grid1">
                <asp:Label Text="Comments:" ID="lblComm" runat="server" />
            ...
            <tr>
                <td align="right" class="td_lines td_up Grid1" >
                    ...
                    <asp:Button Text="Complete" ID="btnComplete" OnClick="BtnComplete_Click" runat="server" CssClass="Button" />
                    <asp:Button Text="Review" ID="btnReview" OnClick="BtnReview_Click" OnClientClick="return Validate()" runat="server" CssClass="Button" />
                    <asp:Button Text="Cancel" ID="btnCancel" OnClick="BtnCancel_Click"  runat="server" CssClass="Button" />
                </td>
            </tr>
        </table>
    </div>
