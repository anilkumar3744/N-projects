...
{
    public partial class H2AppraiserEvaluation : LayoutsPageBase
    {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
                    {
                        using (SPWeb currentWeb = osite.OpenWeb())
                        {
                            ...
                            if (phasesCollection.Count > 0 && phasesCollection != null)
                            {
                            ...
                            SPListItem phaseItemH2;
                            //if (phasesCollectionH2.Count > 0 && phasesCollectionH2 != null)
                            //{
                            phaseItemH2 = phasesCollectionH2[0];
                            ...
                            //if (!string.IsNullOrEmpty(LblH1score1.Text) && !string.IsNullOrEmpty(lblH2Score.Text))
                            //{
                            //    LblFS.Text = Convert.ToString((Convert.ToDecimal(LblH1score1.Text) + Convert.ToDecimal(lblH2Score.Text)) / 2);
                            //}
                            //Lblfr.Text = CommonMaster.GetRating(Convert.ToDecimal(LblFS.Text));

                            #region PIP Commented code
                            ...
                            //SPListItem spItem = CommonMaster.GetMasterDetails("DepartmentHeadEmployeeCode", id);
                        ...
                        {
                            MorePDP(this.dummyTable.Rows.Count);
                        }
                    }
                }
                //decimal finalValue = (total1 + Convert.ToDecimal(LblH1score1.Text)) / 2;
        ...
        private void BindDateTimeControl(string last)
        {
            ...
            {
                LogHandler.LogError(ex, "Error in PMS AppraiserEvaluation H2");
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SPSecurity.RunWithElevatedPrivileges(delegate()
                {
                    ...
                    string url = SPContext.Current.Web.Url + "/_layouts/H2AppraiserEvaluation/H2AppraiserEvaluation.aspx?AppId=" + hfAppraisalID.Value;
            ...
            {
                LogHandler.LogError(ex, "Error in PMS Appraiser Evaluation_Save H2");
                Context.Response.Write("<script type='text/javascript'> " + CommonMaster.serializeMessage(ex.Message) + ";</script>");
            }
            ...
            using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
            {
                using (SPWeb objWeb = osite.OpenWeb())
                {
                    ...
                    foreach (RepeaterItem item in rptGoalSettings.Items)
                    {
                        ...
                        ////Label lblS = item.FindControl("lblS") as Label;//upendra not matched
                        //Label lblH2Score = item.FindControl("lblH2Score") as Label;
                        ...
                        lstItem["agAppraiseeLatestComments"] = lblAppraiseeComments1.Text;
                        ...
                        //lstItem.Update();
                        //objWeb.AllowUnsafeUpdates = false;
                        CommonMaster.BindHistory("Goal, " + txtGoal.Text, Convert.ToInt32(hfAppraisalPhaseID.Value), TxtAprComments.Text, this.currentUser, DateTime.Now.ToString("dd-MMM-yyyy"), lblEmpNameValue.Text, "Appraiser");
                    }
                }
            }
            ...
            using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
            {
                using (SPWeb oWeb = osite.OpenWeb())
                {
                    ...
                    foreach (RepeaterItem item in RptDevelopmentMesure.Items)
                    {
                        ...
                        listItem["pdpH2AppraiseeComments"] = lblAppraise.Text;    //Upendra not matched
                        ...
                        if (!string.IsNullOrEmpty(Convert.ToString(TxtDevComments.Text)))
                            listItem["pdpH2AppraiserComments"] = TxtDevComments.Text;       //upendra not matched
                        listItem["Author"] = this.currentUser;
                ...
                using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
                {
                    using (SPWeb objWeb = osite.OpenWeb())
                    {
                        ...
                        foreach (RepeaterItem item in rptGoalSettings.Items)
                        {
                            ...
                            //Label lblAppraiseeComments1 = item.FindControl("lblAppraiseeComments1") as Label;
                            Label lblS = item.FindControl("lblS") as Label;
                            Label lblH2Score = item.FindControl("lblH2Score") as Label;
                            Label LblCmts = item.FindControl("LblCmts") as Label;
                            TextBox TxtAprComments = item.FindControl("TxtAprComments") as TextBox;
                            ...
                            //phaseItemH2 = lstAppraisalPhases.GetItemById(appraisalPhaseId);

                            // phaseItemH2["aphScore"] = Convert.ToInt32(lblH2Score.Text);
            ...
            try
            {
                using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
                {
                    using (SPWeb objWeb = osite.OpenWeb())
                    {
                        ...
                        foreach (RepeaterItem item in RptDevelopmentMesure.Items)
                        {
                            Label lblSno = item.FindControl("lblSnoVal") as Label;
                            Label LblDeId = item.FindControl("LblDeId") as Label;

                            Label lblwhen = item.FindControl("Label1") as Label;
                            Label lblwhat = item.FindControl("txtwhat") as Label;
                            Label lblNextSteps = item.FindControl("lblNextSteps") as Label;
                            ...
                            listItem["pdpWhen"] = dc.SelectedDate.Date.ToString("dd-MMM-yyyy");
                            listItem["pdpNextSteps"] = Convert.ToString(txtNextSteps.Text);
                            listItem["pdpH2AppraiseeComments"] = lblAppraise.Text;
        ...
        //                listItem["pdpWhat"] = Convert.ToString(txtwhat.Text);
        //                listItem["pdpWhen"] = Convert.ToDateTime(dc.SelectedDate.ToString("dd-MMM-yyyy"));
        //                listItem["pdpNextSteps"] = Convert.ToString(txtNextSteps.Text);
        //                if (!string.IsNullOrEmpty(Convert.ToString(TxtDevComments)))
        ...
        protected void PDPAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (RepeaterItem item in RptDevelopmentMesure.Items)
                {
                    ...
                    {
                        dr["SNo"] = (item.FindControl("lblSnoVal") as Label).Text;
                        dr["pdpWhat"] = (item.FindControl("txtwhat") as TextBox).Text;
                        DateTimeControl dc = item.FindControl("SPDateLastDate1") as DateTimeControl;
                        string strDate = dc.SelectedDate.Date.ToString("dd-MMM-yyyy");
                        dr["pdpWhen"] = strDate;//(item.FindControl("SPDateLastDate1") as DateTimeControl).SelectedDate.ToString();
        ...
        protected void LnkDelete_Click1(object sender, EventArgs e)
        {
            try
            {
                LinkButton lnk = sender as LinkButton;
                RepeaterItem rptItem = lnk.NamingContainer as RepeaterItem;
                Label lblSno = rptItem.FindControl("lblSnoVal") as Label;
                this.DtDevelopmentmesure = ViewState["PDP"] as DataTable;
                int sNo = Convert.ToInt32(lblSno.Text);
                int i = 0;
        ...
        protected void txtWeightage_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                decimal finalValue;
                if (!string.IsNullOrEmpty(LblH1score1.Text))
                    finalValue = (total + Convert.ToDecimal(LblH1score1.Text)) / 2;//
        ...
        protected void LnkDetails_Click(object sender, EventArgs e)
        {
            ...
            //string radalertscript = "<script language='javascript'>function f(){ OpenDialog('" + message + "'); </script>";//Sys.Application.remove_load(f);}; Sys.Application.add_load(f);
