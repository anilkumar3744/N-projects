...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="H2AwaitingAppraiserApprove.aspx.cs"
    Inherits="VFS.PMS.ApplicationPages.Layouts.H2initial.H2AwaitingAppraiserApprove"
            ...
            if (flag1) {
                $('.ExpectedResult').each(function (i, obj) {
                    if ($(this).prop("selectedIndex") == 0) {
                        ...
                        alert('Please specify Expected Result for the Competencies at row: ' + row);
                        $(this).focus();
                        flag2 = false;
                        return false;
                    }
...
<asp:content id="Main" contentplaceholderid="PlaceHolderMain" runat="server">
    ...
    <%--<asp:UpdatePanel runat="server" ID="upnlAwaiting">
        <ContentTemplate>--%>
    <div class="tabs">
    ...
    <div runat="server" id="dvCompetencies" class="tab2">
        <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
            ...
            <asp:Repeater ID="rptCompetencies" runat="server" >
                ...
                <ItemTemplate>
                    <tr>
                        <td class="Grid1 td_lines" style="vertical-align:top">
                            <asp:Label Text='<%#Eval("SNo") %>' runat="server" ID="lblSno" />
                        </td>
                        ...
                        <td class="td_lines" align="center" style="vertical-align:top">
        ...
        <table cellpadding="7px" cellspacing="2px" width="100%" class="buttondiv">
            <tr>
                ...
                <asp:Button Text="Print" ID="btnPrint" runat="server" CssClass="Button" OnClientClick="printCert();return false;" />
                    ...
                    <asp:Button Text="Approve" ID="btnApprove" runat="server" OnClick="BtnApprove_Click"
