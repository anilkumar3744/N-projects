...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="H2AmmendGoals.aspx.cs"
    Inherits="VFS.PMS.ApplicationPages.Layouts.H2initial.H2AmmendGoals" DynamicMasterPageFile="~masterurl/default.master" %>
...
////            });
            ...
            var IsAppraiser = document.getElementById('<%=hfldIsAppraiser.ClientID%>').value;
            if (flag1 && IsAppraiser == "true") {
                $('.ExpectedResult').each(function (i, obj) {
                    if ($(this).prop("selectedIndex") == 0) {
                        ...
                        alert('Please specify Expected Result for the Competency at row: ' + row);
                        $(this).focus();
                        flag2 = false;
                        return false;
                    }
...
<asp:content id="Main" contentplaceholderid="PlaceHolderMain" runat="server">
   ...
   <asp:UpdatePanel runat="server" ID="upnlInitialGoalSetting">
    ...
    <div>
        ...
        <ContentTemplate>
                    <asp:LinkButton ID="lnkViewH1Details" runat="server" Text="View H1 Details" Font-Underline="true" OnClientClick="javascript:return OpenDialog();"></asp:LinkButton>
                    </ContentTemplate>
    </asp:UpdatePanel>
                </td>
            </tr>
        ...
        <tr>
            <td colspan="6" align="right">
             ...
             <asp:Button Text="Print" ID="btnPrint" CssClass="Button"  runat="server" OnClientClick="printCert();return false;" />
                ...
                <asp:Button Text="Approve" ID="btnApprove" Visible="false" runat="server" OnClick="BtnApprove_Click"
