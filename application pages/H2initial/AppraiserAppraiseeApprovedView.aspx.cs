    ...
    public partial class AppraiserAppraiseeApprovedView : LayoutsPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //message = message = SPContext.Current.Web.Url + "/_layouts/VFSProjectH1/HRView.aspx?AppId=" + Request.Params["AppId"] + "&IsDlg=1";
                message = message = SPContext.Current.Web.Url + "/_layouts/VFSProjectH1/HRView.aspx?AppId=" + Request.Params["AppId"] + "&IsDlg=1&from=popup";
                //message = SPContext.Current.Web.Url + "/_layouts/H2initial/AppraiserAppraiseeApprovedView.aspx?TaskID=&AppId=1189" + "&IsDlg=1";
                ...
                if (!this.IsPostBack)
                {
                    ...
                    using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
                    {
                        ...
                        //}
                        // modified by tataji for amend button
                        string id = string.Empty;
                        string currentUser1 = SPContext.Current.Web.CurrentUser.LoginName.Split('\\')[1];
            ...
            {
                LogHandler.LogError(ex, "Error in PMS H12 Appraiser Appraisee Approved View");
        ...
        protected void BtnAmmend_Click(object sender, EventArgs e)
        {
            using (SPSite osite = new SPSite(SPContext.Current.Web.Url))
            {
                ...
                {
                    //hfAppraisalID.Value = Convert.ToString(Request.Params["AppId"]);
                    Response.Redirect(SPContext.Current.Web.Url + "/_layouts/H2initial/H2AmmendGoals.aspx?AppId=" + Convert.ToInt32(Request.Params["AppId"]), false);
                    //Response.End();
                }
            }
        }
