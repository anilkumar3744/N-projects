...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="H1AppraiserReEvaluation.aspx.cs"
    Inherits="VFS.PMS.ApplicationPages.Layouts.H1AppraiserReEvaluation.H1AppraiserReEvaluation"
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <asp:UpdatePanel ID="Upadatepanel" runat="server">
        ...
        <ContentTemplate>
            <div>
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="" style="padding: 0px;">
                    <tr>
                ...
                <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                    ...
                    <asp:Repeater ID="rptGoalSettings" runat="server">
                        <HeaderTemplate>
                            <tr class="GridHead">
                                ...
                                <td align="center" class="td_lines" style="width: 10%;">
                                    <asp:Label Text="Action" runat="server" ID="lblActionH" />
                                </td>
                            </tr>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="td_lines Grid1">
                                    ...
                                    <asp:DropDownList ID="ddlCategories" runat="server" Visible="false" CssClass="TextBox category validation">
                                    </asp:DropDownList>
                                </td>
                                ...
                                <td class="td_lines Grid1" style="" align="center">
                                    <asp:TextBox runat="server" AutoPostBack="true" OnTextChanged="txtWeightage_TextChanged"
                                        ID="TxtEvaluation" CssClass="Textbox Evaluation validation" Width="40%" Text='<%#Eval("agEvaluation") %>'
                                ...
                                <td class="td_lines Grid1">
                                    <%--<asp:LinkButton Text="Delete" ID="lnkDelete" OnClick="LnkDelete_Click" Visible="false"
                                      OnClientClick="return confirmation()"  runat="server" CommandArgument='<%#Eval("ID") %>' />--%>
                            ...
                            <tr>
                                ...
                                <td colspan="7" class="td_lines Grid1" align="left">
                                    <asp:Label ID="LblCmts" Text="Appraiser Appeal Comments" runat="server" CssClass="comments1" />
                    ...
                    <%--<tr>
                        <td class="Grid1" colspan="5">
                            <asp:Label Text="Appraisee Appeal Comments" ID="Label5" runat="server" />
            ...
            <div runat="server" id="dvCompetencies">
                <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                        ...
                        <HeaderTemplate>
                            <tr class="GridHead">
                                ...
                                <td align="center" class="td_lines competebcytdwidth">
                                    <asp:Label Text="Competency" runat="server" ID="lblcompetenciesCH" />
                                </td>
                                <td align="center" class="td_lines">
                                    <asp:Label Text="Expected Results" runat="server" ID="lblexpectedresultCH" />
                                </td>
                                <td align="center" class="td_lines">
                                    <asp:Label Text="Rating" runat="server" ID="LblratingCH" />
                                </td>
                            </tr>
                        </HeaderTemplate>
                        <ItemTemplate>
                            ...
                            <tr>
                                ...
                                <td class="td_lines Grid1" colspan="7">
                                    <asp:Label Text="Appraiser Appeal Comments" ID="LblComments" runat="server" />
                    ...
                    <tr>
                        <%--<td class="Grid1" colspan="5">
                            <asp:Label Text="Appraisee Appeal Comments" ID="Label3" runat="server" />
            ...
            <div id="divdevelopmentmessures" runat="server">
                ...
                <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                    ...
                    <asp:Repeater ID="RptDevelopmentMesure" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="left" class="td_lines Grid1">
                                    <SharePoint:DateTimeControl LocaleId="2057" runat="server" ID="SPDateLastDate" CssClassTextBox="Devmesure When datecss"
                                        DateOnly="true" />
                                </td>
                                <td align="left" class="td_lines Grid1">
                            ...
                            <tr>
                                ...
                                <td class="td_lines Grid1" colspan="4">
                                    <asp:Label Text="Appraiser Appeal Comments" ID="LblDemcomments" runat="server" />
                            ...
                            <%--<tr>
                                ...
                                <td class="td_lines Grid1" colspan="4">
                                    <asp:Label Text="Reviewer" ID="LblReviewer" runat="server" />
                                    <asp:Label Text='<%#Eval("pdpH1AppraiserComments") %>' ID="LblReviwerComments" runat="server" />
                                </td>
                            </tr>--%>
                        </ItemTemplate>
                    </asp:Repeater>
                    ...
                    <%--<tr>
                        <td class="Grid1" colspan="5">
                            <asp:Label Text="Appraisee Appeal Comments" ID="LblAAC" runat="server" />
                            ...
                            <tr>
                                ...
                                <td align="center" class="td_lines Grid1" style="">
                                    ...
                                    <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipPerformanceIssue") %>' CssClass="PIPMandatory performance"
                                        ID="txtPerformanceIssu" runat="server" Width="99%" />
                                </td>
                                <td align="center" class="td_lines Grid1" style="">
                                    ...
                                    <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipExpectedachivement") %>' CssClass="PIPMandatory achivement"
                                        ID="txtExpectedAchivements" runat="server" Width="99%" />
                                </td>
                                <td align="center" class="td_lines Grid1" style="">
                                    <asp:Label Text='<%#Eval("pipTimeFrame") %>' ID="lblTimeFrame" CssClass="Grid1" runat="server"
                                        Visible="false" />
                                    <asp:TextBox TextMode="MultiLine" Text='<%#Eval("pipTimeFrame") %>' CssClass="PIPMandatory TimeFrame"
            ...
            <div id="divButtons" runat="server" style="display: block">
                <table cellpadding="7px" cellspacing="2px" width="100%" style="border: 1px solid;
                    ...
                    <tr>
                        <td class="Grid1" colspan="5">
                            <asp:Label Text="Appraisee Appeal Comments:" ID="Label3" runat="server" />
                            <asp:Label ID="lblAppraiseeAppealFinalComments" runat="server" />
                        </td>
                    </tr>
                    <tr>
...
<asp:Content ID="PageTitle" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    H1-Appraiser Re Evaluation Page
</asp:Content>
