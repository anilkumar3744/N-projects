<%@ Assembly Name="VFS_Masterspages, Version=1.0.0.0, Culture=neutral, PublicKeyToken=0f543f2ed50db5a7" %>
...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Competency.aspx.cs" Inherits="VFS_Masterspages.Layouts.VFS_Masterspages.Competency"
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    <div>
        <asp:GridView ID="ComptencyGridview" AutoGenerateColumns="false" runat="server" CssClass="Grid fullWidth"
            PageSize="5" AllowPaging="true" OnPageIndexChanging="ComptencyGridview_PageIndexChanging"
            PagerStyle-CssClass="gvPagerCss" Font-Bold="false" AlternatingRowStyle-CssClass="GridAlt"
            OnRowCommand="ComptencyGridview_RowCommand">
            <RowStyle CssClass="gridRowHeight" />
            <HeaderStyle CssClass="gridRowHeight GridHead" />
            <Columns>
                <asp:BoundField HeaderText="Competency" DataField="cmptCompetency1" />
                <asp:TemplateField>
                    <ItemTemplate>
    ...
    <div id="Competency_Form" class="reminders_edit" runat="server" visible="false">
        <table class="Grid CompetencyDescription_Form1 Performance_rating_second_table" style="width: 41%;">
            <tr>
                <td>
                    <asp:Label Text="Competency" ID="lblCompetency" runat="server" CssClass="Lblbold" />
                </td>
                <td>
                    <asp:TextBox runat="server" ID="txtCompetency" CssClass="Textbox" Style="width: 250px;" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="Group1"
                        runat="server" ErrorMessage="Please enter competency" ControlToValidate="txtCompetency"
            ...
            <tr>
                ...
                <td align="center">
                    <asp:Button Text="Submit" ID="btn_Submit" OnClick="btnSubmit_OnClick" ValidationGroup="Group1"
                        runat="server" CssClass="Button" />
                    <asp:Button Text="Cancel" ID="btnCancel" OnClick="btnCancel_OnClick" runat="server"
                        CssClass="Button" Style="margin-right: 2%;" />
                </td>
            </tr>
        </table>
    </div>
